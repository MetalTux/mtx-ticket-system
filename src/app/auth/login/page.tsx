  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 py-12 transition-colors duration-500">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl dark:shadow-2xl dark:shadow-black/50 border border-slate-100 dark:border-slate-800 transition-colors duration-500">
          ...
          <Suspense 
            fallback={
              <div className="flex flex-col items-center justify-center py-8 space-y-4">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Iniciando sistema...</p>
              </div>
            }
          >
            <LoginForm />
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
            <p className="text-[9px] uppercase font-black tracking-[0.2em] text-slate-400 dark:text-slate-500">
              Soporte y Operaciones Técincas
            </p>
          </div>
        </div>
