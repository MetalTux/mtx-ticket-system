...
export default async function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: "Clientes", href: "/dashboard/clients", icon: Icons.Clients, show: (role === "ADMIN" || role === "SOPORTE" || role === "DESARROLLO" || role === "VENTAS") },
    { label: "Usuarios", href: "/dashboard/users", icon: Icons.Users, show: (role === "ADMIN" || role === "SOPORTE" || role === "DESARROLLO" || role === "VENTAS") },
  ];
